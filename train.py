...
def train(data_yaml, model='yolo12m.pt', epochs=100, batch_size=16, img_size=640):
    ...
    results = model.train(
        ...
        name='chess_detection',    # Name for the training run
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='yolo12m.pt', help="YOLO model variant")
